...
async def analyze_code(request: CodeAnalysisRequest):
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="An error occurred during code analysis"
        )
...
async def analyze_batch(request: BatchAnalysisRequest):
    ...
    **Returns:**
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="An error occurred during batch analysis"
        )
...
async def analyze_code_async(
    ...
    **Returns:**
    ...
    background_tasks.add_task(_process_async_scan, scan_id, request)
...
async def get_supported_languages():
    ...
    **Returns:**
    ...
    return {"languages": [lang.value for lang in LanguageEnum], "default": "python"}
...
async def get_vulnerability_types():
    ...
    **Returns:**
    ...
    from ...services.code_analyzer import (CWE_MAPPING, OWASP_MAPPING,
                                           SEVERITY_MAPPING)
        ...
        types.append(
            {
                ...
                "severity": (
                    SEVERITY_MAPPING.get(label, "medium").value
                    if hasattr(SEVERITY_MAPPING.get(label, "medium"), "value")
                    else "medium"
                ),
            }
        )
